...
def data_index(request: Request, dir: str = "", file: str = ""):
    ...
    return templates.TemplateResponse(request, "data/viewer.html", ctx)
...
def data_preview(request: Request, file_path: str):
    ...
    if is_htmx(request):
        return templates.TemplateResponse(request, "partials/_data_preview.html", ctx)
...
def data_gallery(request: Request, dir_path: str):
    ...
    return templates.TemplateResponse(request, "partials/_image_gallery.html", ctx)
